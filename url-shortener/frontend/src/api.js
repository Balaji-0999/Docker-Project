...
const API_BASE = 'http://54.243.18.239:5000/api';
...
export const shortenUrl = (originalUrl, customAlias, expiresIn, password) =>
  api.post('/links/shorten', { originalUrl, customAlias, expiresIn, password });
